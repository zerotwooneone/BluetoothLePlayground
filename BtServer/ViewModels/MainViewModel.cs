...
namespace BtServer.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        private bool _serverPanelVisible;
        private bool _peripheralWarningPanelVisible;
        ...
        public bool ServerPanelVisible
        {
            get => _serverPanelVisible;
            set => SetProperty(ref _serverPanelVisible, value);
        }

        public bool PeripheralWarningPanelVisible
        {
            ...
            Dictionary<string, object> viewModelState)
        {
...

            {
                ...
                PeripheralWarningPanelVisible = true;
